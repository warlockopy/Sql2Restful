...
//source: CoolantTemperatureProto.proto

public final class CoolantTemperatureProto {
private CoolantTemperatureProto() {}
public static void registerAllExtensions(
   com.google.protobuf.ExtensionRegistry registry) {
}
public interface CoolantTemperatureOrBuilder extends
   // @@protoc_insertion_point(interface_extends:CoolantTemperature)
...
/**
* Protobuf type {@code CoolantTemperature}
*
* <pre>
* Coolant temperature event generated when limit is reached
* </pre>
*/
public static final class CoolantTemperature extends
   com.google.protobuf.GeneratedMessage implements
   // @@protoc_insertion_point(message_implements:CoolantTemperature)
   CoolantTemperatureOrBuilder {
 // Use CoolantTemperature.newBuilder() to construct.
 private CoolantTemperature(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
   super(builder);
   this.unknownFields = builder.getUnknownFields();
 }
 private CoolantTemperature(boolean noInit) { this.unknownFields = com.google.protobuf.UnknownFieldSet.getDefaultInstance(); }

 private static final CoolantTemperature defaultInstance;
 public static CoolantTemperature getDefaultInstance() {
   return defaultInstance;
 }

 public CoolantTemperature getDefaultInstanceForType() {
   return defaultInstance;
 }
 ...
 public static final com.google.protobuf.Descriptors.Descriptor
     getDescriptor() {
   return CoolantTemperatureProto.internal_static_CoolantTemperature_descriptor;
 }

 protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
     internalGetFieldAccessorTable() {
   return CoolantTemperatureProto.internal_static_CoolantTemperature_fieldAccessorTable
       .ensureFieldAccessorsInitialized(
           CoolantTemperatureProto.CoolantTemperature.class, CoolantTemperatureProto.CoolantTemperature.Builder.class);
 }

 public static com.google.protobuf.Parser<CoolantTemperature> PARSER =
     new com.google.protobuf.AbstractParser<CoolantTemperature>() {
   public CoolantTemperature parsePartialFrom(
       com.google.protobuf.CodedInputStream input,
       com.google.protobuf.ExtensionRegistryLite extensionRegistry)
       throws com.google.protobuf.InvalidProtocolBufferException {
     return new CoolantTemperature(input, extensionRegistry);
   }
 };

 @java.lang.Override
 public com.google.protobuf.Parser<CoolantTemperature> getParserForType() {
   return PARSER;
 }
 ...
 public static CoolantTemperatureProto.CoolantTemperature parseFrom(
 ...
 public static CoolantTemperatureProto.CoolantTemperature parseFrom(byte[] data)
     throws com.google.protobuf.InvalidProtocolBufferException {
   return PARSER.parseFrom(data);
 }
 public static CoolantTemperatureProto.CoolantTemperature parseFrom(
 ...
 public static CoolantTemperatureProto.CoolantTemperature parseFrom(java.io.InputStream input)
     throws java.io.IOException {
 ...
 public static CoolantTemperatureProto.CoolantTemperature parseDelimitedFrom(java.io.InputStream input)
     throws java.io.IOException {
   return PARSER.parseDelimitedFrom(input);
 }
 public static CoolantTemperatureProto.CoolantTemperature parseDelimitedFrom(
     java.io.InputStream input,
     com.google.protobuf.ExtensionRegistryLite extensionRegistry)
     throws java.io.IOException {
 ...
 public static Builder newBuilder(CoolantTemperatureProto.CoolantTemperature prototype) {
 ...
 public static final class Builder extends
     ...
     // @@protoc_insertion_point(builder_implements:CoolantTemperature)
     CoolantTemperatureProto.CoolantTemperatureOrBuilder {
   public static final com.google.protobuf.Descriptors.Descriptor
       getDescriptor() {
     return CoolantTemperatureProto.internal_static_CoolantTemperature_descriptor;
   }
   ...
   // Construct using CoolantTemperatureProto.CoolantTemperature.newBuilder()
   private Builder() {
   ...
   public CoolantTemperatureProto.CoolantTemperature getDefaultInstanceForType() {
     return CoolantTemperatureProto.CoolantTemperature.getDefaultInstance();
   }

   public CoolantTemperatureProto.CoolantTemperature build() {
     CoolantTemperatureProto.CoolantTemperature result = buildPartial();
   ...
   public CoolantTemperatureProto.CoolantTemperature buildPartial() {
     CoolantTemperatureProto.CoolantTemperature result = new CoolantTemperatureProto.CoolantTemperature(this);
   ...
   public Builder mergeFrom(com.google.protobuf.Message other) {
     if (other instanceof CoolantTemperatureProto.CoolantTemperature) {
       return mergeFrom((CoolantTemperatureProto.CoolantTemperature)other);
     } else {
   ...
   public Builder mergeFrom(CoolantTemperatureProto.CoolantTemperature other) {
     if (other == CoolantTemperatureProto.CoolantTemperature.getDefaultInstance()) return this;
     if (other.hasHeader()) {
   ...
   public Builder mergeFrom(
       ...
       com.google.protobuf.ExtensionRegistryLite extensionRegistry)
       throws java.io.IOException {
     CoolantTemperatureProto.CoolantTemperature parsedMessage = null;
     try {
       parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
     } catch (com.google.protobuf.InvalidProtocolBufferException e) {
       parsedMessage = (CoolantTemperatureProto.CoolantTemperature) e.getUnfinishedMessage();
       throw e;
     } finally {
   ...
   // @@protoc_insertion_point(builder_scope:CoolantTemperature)
 }

 static {
   defaultInstance = new CoolantTemperature(true);
   defaultInstance.initFields();
 }

 // @@protoc_insertion_point(class_scope:CoolantTemperature)
}

private static final com.google.protobuf.Descriptors.Descriptor
 internal_static_CoolantTemperature_descriptor;
private static
 com.google.protobuf.GeneratedMessage.FieldAccessorTable
   internal_static_CoolantTemperature_fieldAccessorTable;
...
static {
 java.lang.String[] descriptorData = {
   "\n\035CoolantTemperatureProto.proto\032\026EventHe" +
   "aderProto.proto\"\356\002\n\022CoolantTemperature\022\034" +
   "\n\006header\030\001 \002(\0132\014.EventHeader\022\022\n\nmil_stat" +
   "us\030\002 \001(\r\022\013\n\003rpm\030\003 \001(\r\022\031\n\021throttle_positi" +
   "on\030\004 \001(\r\022\031\n\021engine_load_value\030\005 \001(\r\022\031\n\021e" +
   "ngine_load_limit\030\006 \001(\r\022\036\n\026engine_load_ti" +
   "me_limit\030\007 \001(\r\022\"\n\032engine_coolant_tempera" +
   "ture\030\010 \001(\021\022(\n engine_coolant_temperature" +
   "_limit\030\t \001(\r\022\030\n\020fuel_level_value\030\n \001(\r\022\034" +
   "\n\024fuel_level_low_limit\030\013 \001(\r\022\"\n\032instanta",
   "neous_fuel_economy\030\014 \001(\r"
 };
 ...
 internal_static_CoolantTemperature_fieldAccessorTable = new
   com.google.protobuf.GeneratedMessage.FieldAccessorTable(
     internal_static_CoolantTemperature_descriptor,
