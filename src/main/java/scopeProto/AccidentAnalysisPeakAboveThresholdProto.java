...
//source: AccidentAnalysisPeakAboveThresholdProto.proto
...
public interface AccidentAnalysisPeakAboveThresholdOrBuilder extends
   // @@protoc_insertion_point(interface_extends:AccidentAnalysisPeakAboveThreshold)
...
/**
* Protobuf type {@code AccidentAnalysisPeakAboveThreshold}
*
* <pre>
* Accident Analysis - Accident Peak Above Threshold event occurs when the average accelerometer reading is below the threshold,
* but the maximum accelerometer reading is above the threshold.
* </pre>
*/
public static final class AccidentAnalysisPeakAboveThreshold extends
   com.google.protobuf.GeneratedMessage implements
   // @@protoc_insertion_point(message_implements:AccidentAnalysisPeakAboveThreshold)
   AccidentAnalysisPeakAboveThresholdOrBuilder {
 // Use AccidentAnalysisPeakAboveThreshold.newBuilder() to construct.
 private AccidentAnalysisPeakAboveThreshold(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
   super(builder);
   this.unknownFields = builder.getUnknownFields();
 }
 private AccidentAnalysisPeakAboveThreshold(boolean noInit) { this.unknownFields = com.google.protobuf.UnknownFieldSet.getDefaultInstance(); }

 private static final AccidentAnalysisPeakAboveThreshold defaultInstance;
 ...
 protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
   ...
   return AccidentAnalysisPeakAboveThresholdProto.internal_static_AccidentAnalysisPeakAboveThreshold_fieldAccessorTable
       .ensureFieldAccessorsInitialized(
           AccidentAnalysisPeakAboveThresholdProto.AccidentAnalysisPeakAboveThreshold.class, AccidentAnalysisPeakAboveThresholdProto.AccidentAnalysisPeakAboveThreshold.Builder.class);
 }

 public static com.google.protobuf.Parser<AccidentAnalysisPeakAboveThreshold> PARSER =
     new com.google.protobuf.AbstractParser<AccidentAnalysisPeakAboveThreshold>() {
   public AccidentAnalysisPeakAboveThreshold parsePartialFrom(
       com.google.protobuf.CodedInputStream input,
       com.google.protobuf.ExtensionRegistryLite extensionRegistry)
       throws com.google.protobuf.InvalidProtocolBufferException {
     return new AccidentAnalysisPeakAboveThreshold(input, extensionRegistry);
   }
 };

 @java.lang.Override
 public com.google.protobuf.Parser<AccidentAnalysisPeakAboveThreshold> getParserForType() {
   return PARSER;
 }
 ...
 public static AccidentAnalysisPeakAboveThresholdProto.AccidentAnalysisPeakAboveThreshold parseFrom(
 ...
 public static AccidentAnalysisPeakAboveThresholdProto.AccidentAnalysisPeakAboveThreshold parseFrom(byte[] data)
     throws com.google.protobuf.InvalidProtocolBufferException {
   return PARSER.parseFrom(data);
 }
 public static AccidentAnalysisPeakAboveThresholdProto.AccidentAnalysisPeakAboveThreshold parseFrom(
 ...
 public static AccidentAnalysisPeakAboveThresholdProto.AccidentAnalysisPeakAboveThreshold parseFrom(java.io.InputStream input)
     throws java.io.IOException {
 ...
 public static AccidentAnalysisPeakAboveThresholdProto.AccidentAnalysisPeakAboveThreshold parseDelimitedFrom(java.io.InputStream input)
     throws java.io.IOException {
   return PARSER.parseDelimitedFrom(input);
 }
 public static AccidentAnalysisPeakAboveThresholdProto.AccidentAnalysisPeakAboveThreshold parseDelimitedFrom(
     java.io.InputStream input,
     com.google.protobuf.ExtensionRegistryLite extensionRegistry)
     throws java.io.IOException {
 ...
 public static Builder newBuilder(AccidentAnalysisPeakAboveThresholdProto.AccidentAnalysisPeakAboveThreshold prototype) {
 ...
 public static final class Builder extends
     ...
     // @@protoc_insertion_point(builder_implements:AccidentAnalysisPeakAboveThreshold)
     AccidentAnalysisPeakAboveThresholdProto.AccidentAnalysisPeakAboveThresholdOrBuilder {
   public static final com.google.protobuf.Descriptors.Descriptor
       getDescriptor() {
     return AccidentAnalysisPeakAboveThresholdProto.internal_static_AccidentAnalysisPeakAboveThreshold_descriptor;
   }
   ...
   // Construct using AccidentAnalysisPeakAboveThresholdProto.AccidentAnalysisPeakAboveThreshold.newBuilder()
   private Builder() {
   ...
   public AccidentAnalysisPeakAboveThresholdProto.AccidentAnalysisPeakAboveThreshold getDefaultInstanceForType() {
     return AccidentAnalysisPeakAboveThresholdProto.AccidentAnalysisPeakAboveThreshold.getDefaultInstance();
   }

   public AccidentAnalysisPeakAboveThresholdProto.AccidentAnalysisPeakAboveThreshold build() {
     AccidentAnalysisPeakAboveThresholdProto.AccidentAnalysisPeakAboveThreshold result = buildPartial();
   ...
   public AccidentAnalysisPeakAboveThresholdProto.AccidentAnalysisPeakAboveThreshold buildPartial() {
     AccidentAnalysisPeakAboveThresholdProto.AccidentAnalysisPeakAboveThreshold result = new AccidentAnalysisPeakAboveThresholdProto.AccidentAnalysisPeakAboveThreshold(this);
   ...
   public Builder mergeFrom(com.google.protobuf.Message other) {
     if (other instanceof AccidentAnalysisPeakAboveThresholdProto.AccidentAnalysisPeakAboveThreshold) {
       return mergeFrom((AccidentAnalysisPeakAboveThresholdProto.AccidentAnalysisPeakAboveThreshold)other);
     } else {
   ...
   public Builder mergeFrom(AccidentAnalysisPeakAboveThresholdProto.AccidentAnalysisPeakAboveThreshold other) {
     if (other == AccidentAnalysisPeakAboveThresholdProto.AccidentAnalysisPeakAboveThreshold.getDefaultInstance()) return this;
     if (other.hasHeader()) {
   ...
   public Builder mergeFrom(
       ...
       com.google.protobuf.ExtensionRegistryLite extensionRegistry)
       throws java.io.IOException {
     AccidentAnalysisPeakAboveThresholdProto.AccidentAnalysisPeakAboveThreshold parsedMessage = null;
     try {
       parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
     } catch (com.google.protobuf.InvalidProtocolBufferException e) {
       parsedMessage = (AccidentAnalysisPeakAboveThresholdProto.AccidentAnalysisPeakAboveThreshold) e.getUnfinishedMessage();
       throw e;
     } finally {
   ...
   // @@protoc_insertion_point(builder_scope:AccidentAnalysisPeakAboveThreshold)
 }

 static {
   defaultInstance = new AccidentAnalysisPeakAboveThreshold(true);
   defaultInstance.initFields();
 }

 // @@protoc_insertion_point(class_scope:AccidentAnalysisPeakAboveThreshold)
}

private static final com.google.protobuf.Descriptors.Descriptor
 internal_static_AccidentAnalysisPeakAboveThreshold_descriptor;
private static
...
static {
 java.lang.String[] descriptorData = {
   "\n-AccidentAnalysisPeakAboveThresholdProt" +
   "o.proto\032\026EventHeaderProto.proto\"\350\003\n\"Acci" +
   "dentAnalysisPeakAboveThreshold\022\034\n\006header" +
   "\030\001 \002(\0132\014.EventHeader\022#\n\033event_duration_m" +
   "illisceonds\030\002 \001(\r\022\027\n\017start_speed_kmh\030\003 \001" +
   "(\r\022\031\n\021accident_latitude\030\004 \001(\001\022\032\n\022acciden" +
   "t_longitude\030\005 \001(\001\022\032\n\022max_acceleration_r\030" +
   "\006 \001(\002\022\036\n\026average_acceleration_r\030\007 \001(\002\022\036\n" +
   "\026average_acceleration_x\030\010 \001(\002\022\036\n\026average" +
   "_acceleration_y\030\t \001(\002\022\036\n\026average_acceler",
   "ation_z\030\n \001(\002\022\017\n\007max_rpm\030\013 \001(\r\022\037\n\027max_th" +
   "rottle_percentage\030\014 \001(\002\022\036\n\026timestamp_mil" +
   "liseconds\030\r \001(\r\022\037\n\027start_direction_degre" +
   "es\030\016 \001(\002\022 \n\030impact_direction_degrees\030\017 \001" +
   "(\002"
 };
 ...
 internal_static_AccidentAnalysisPeakAboveThreshold_fieldAccessorTable = new
   com.google.protobuf.GeneratedMessage.FieldAccessorTable(
     internal_static_AccidentAnalysisPeakAboveThreshold_descriptor,
