...
//source: Analog1HighProto.proto

public final class Analog1HighProto {
private Analog1HighProto() {}
public static void registerAllExtensions(
   com.google.protobuf.ExtensionRegistry registry) {
}
public interface Analog1HighOrBuilder extends
   // @@protoc_insertion_point(interface_extends:Analog1High)
...
/**
* Protobuf type {@code Analog1High}
*
* <pre>
* Analogue input 1 voltage is high
* </pre>
*/
public static final class Analog1High extends
   com.google.protobuf.GeneratedMessage implements
   // @@protoc_insertion_point(message_implements:Analog1High)
   Analog1HighOrBuilder {
 // Use Analog1High.newBuilder() to construct.
 private Analog1High(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
   super(builder);
   this.unknownFields = builder.getUnknownFields();
 }
 private Analog1High(boolean noInit) { this.unknownFields = com.google.protobuf.UnknownFieldSet.getDefaultInstance(); }

 private static final Analog1High defaultInstance;
 public static Analog1High getDefaultInstance() {
   return defaultInstance;
 }

 public Analog1High getDefaultInstanceForType() {
   return defaultInstance;
 }
 ...
 public static final com.google.protobuf.Descriptors.Descriptor
     getDescriptor() {
   return Analog1HighProto.internal_static_Analog1High_descriptor;
 }

 protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
     internalGetFieldAccessorTable() {
   return Analog1HighProto.internal_static_Analog1High_fieldAccessorTable
       .ensureFieldAccessorsInitialized(
           Analog1HighProto.Analog1High.class, Analog1HighProto.Analog1High.Builder.class);
 }

 public static com.google.protobuf.Parser<Analog1High> PARSER =
     new com.google.protobuf.AbstractParser<Analog1High>() {
   public Analog1High parsePartialFrom(
       com.google.protobuf.CodedInputStream input,
       com.google.protobuf.ExtensionRegistryLite extensionRegistry)
       throws com.google.protobuf.InvalidProtocolBufferException {
     return new Analog1High(input, extensionRegistry);
   }
 };

 @java.lang.Override
 public com.google.protobuf.Parser<Analog1High> getParserForType() {
   return PARSER;
 }
 ...
 public static Analog1HighProto.Analog1High parseFrom(
 ...
 public static Analog1HighProto.Analog1High parseFrom(byte[] data)
     throws com.google.protobuf.InvalidProtocolBufferException {
   return PARSER.parseFrom(data);
 }
 public static Analog1HighProto.Analog1High parseFrom(
 ...
 public static Analog1HighProto.Analog1High parseFrom(java.io.InputStream input)
     throws java.io.IOException {
 ...
 public static Analog1HighProto.Analog1High parseDelimitedFrom(java.io.InputStream input)
     throws java.io.IOException {
   return PARSER.parseDelimitedFrom(input);
 }
 public static Analog1HighProto.Analog1High parseDelimitedFrom(
     java.io.InputStream input,
     com.google.protobuf.ExtensionRegistryLite extensionRegistry)
     throws java.io.IOException {
 ...
 public static Builder newBuilder(Analog1HighProto.Analog1High prototype) {
 ...
 public static final class Builder extends
     ...
     // @@protoc_insertion_point(builder_implements:Analog1High)
     Analog1HighProto.Analog1HighOrBuilder {
   public static final com.google.protobuf.Descriptors.Descriptor
       getDescriptor() {
     return Analog1HighProto.internal_static_Analog1High_descriptor;
   }
   ...
   // Construct using Analog1HighProto.Analog1High.newBuilder()
   private Builder() {
   ...
   public Analog1HighProto.Analog1High getDefaultInstanceForType() {
     return Analog1HighProto.Analog1High.getDefaultInstance();
   }

   public Analog1HighProto.Analog1High build() {
     Analog1HighProto.Analog1High result = buildPartial();
   ...
   public Analog1HighProto.Analog1High buildPartial() {
     Analog1HighProto.Analog1High result = new Analog1HighProto.Analog1High(this);
   ...
   public Builder mergeFrom(com.google.protobuf.Message other) {
     if (other instanceof Analog1HighProto.Analog1High) {
       return mergeFrom((Analog1HighProto.Analog1High)other);
     } else {
   ...
   public Builder mergeFrom(Analog1HighProto.Analog1High other) {
     if (other == Analog1HighProto.Analog1High.getDefaultInstance()) return this;
     if (other.hasHeader()) {
   ...
   public Builder mergeFrom(
       ...
       com.google.protobuf.ExtensionRegistryLite extensionRegistry)
       throws java.io.IOException {
     Analog1HighProto.Analog1High parsedMessage = null;
     try {
       parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
     } catch (com.google.protobuf.InvalidProtocolBufferException e) {
       parsedMessage = (Analog1HighProto.Analog1High) e.getUnfinishedMessage();
       throw e;
     } finally {
   ...
   // @@protoc_insertion_point(builder_scope:Analog1High)
 }

 static {
   defaultInstance = new Analog1High(true);
   defaultInstance.initFields();
 }

 // @@protoc_insertion_point(class_scope:Analog1High)
}

private static final com.google.protobuf.Descriptors.Descriptor
 internal_static_Analog1High_descriptor;
private static
 com.google.protobuf.GeneratedMessage.FieldAccessorTable
   internal_static_Analog1High_fieldAccessorTable;
...
static {
 java.lang.String[] descriptorData = {
   "\n\026Analog1HighProto.proto\032\026EventHeaderPro" +
   "to.proto\"\212\001\n\013Analog1High\022\034\n\006header\030\001 \002(\013" +
 ...
 internal_static_Analog1High_fieldAccessorTable = new
   com.google.protobuf.GeneratedMessage.FieldAccessorTable(
     internal_static_Analog1High_descriptor,
