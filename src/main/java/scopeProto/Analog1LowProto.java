...
//source: Analog1LowProto.proto

public final class Analog1LowProto {
private Analog1LowProto() {}
public static void registerAllExtensions(
   com.google.protobuf.ExtensionRegistry registry) {
}
public interface Analog1LowOrBuilder extends
   // @@protoc_insertion_point(interface_extends:Analog1Low)
...
/**
* Protobuf type {@code Analog1Low}
*
* <pre>
* Analogue input 1 is low
* </pre>
*/
public static final class Analog1Low extends
   com.google.protobuf.GeneratedMessage implements
   // @@protoc_insertion_point(message_implements:Analog1Low)
   Analog1LowOrBuilder {
 // Use Analog1Low.newBuilder() to construct.
 private Analog1Low(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
   super(builder);
   this.unknownFields = builder.getUnknownFields();
 }
 private Analog1Low(boolean noInit) { this.unknownFields = com.google.protobuf.UnknownFieldSet.getDefaultInstance(); }

 private static final Analog1Low defaultInstance;
 public static Analog1Low getDefaultInstance() {
   return defaultInstance;
 }

 public Analog1Low getDefaultInstanceForType() {
   return defaultInstance;
 }
 ...
 public static final com.google.protobuf.Descriptors.Descriptor
     getDescriptor() {
   return Analog1LowProto.internal_static_Analog1Low_descriptor;
 }

 protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
     internalGetFieldAccessorTable() {
   return Analog1LowProto.internal_static_Analog1Low_fieldAccessorTable
       .ensureFieldAccessorsInitialized(
           Analog1LowProto.Analog1Low.class, Analog1LowProto.Analog1Low.Builder.class);
 }

 public static com.google.protobuf.Parser<Analog1Low> PARSER =
     new com.google.protobuf.AbstractParser<Analog1Low>() {
   public Analog1Low parsePartialFrom(
       com.google.protobuf.CodedInputStream input,
       com.google.protobuf.ExtensionRegistryLite extensionRegistry)
       throws com.google.protobuf.InvalidProtocolBufferException {
     return new Analog1Low(input, extensionRegistry);
   }
 };

 @java.lang.Override
 public com.google.protobuf.Parser<Analog1Low> getParserForType() {
   return PARSER;
 }
 ...
 public static Analog1LowProto.Analog1Low parseFrom(
 ...
 public static Analog1LowProto.Analog1Low parseFrom(byte[] data)
     throws com.google.protobuf.InvalidProtocolBufferException {
   return PARSER.parseFrom(data);
 }
 public static Analog1LowProto.Analog1Low parseFrom(
 ...
 public static Analog1LowProto.Analog1Low parseFrom(java.io.InputStream input)
     throws java.io.IOException {
 ...
 public static Analog1LowProto.Analog1Low parseDelimitedFrom(java.io.InputStream input)
     throws java.io.IOException {
   return PARSER.parseDelimitedFrom(input);
 }
 public static Analog1LowProto.Analog1Low parseDelimitedFrom(
     java.io.InputStream input,
     com.google.protobuf.ExtensionRegistryLite extensionRegistry)
     throws java.io.IOException {
 ...
 public static Builder newBuilder(Analog1LowProto.Analog1Low prototype) {
 ...
 public static final class Builder extends
     ...
     // @@protoc_insertion_point(builder_implements:Analog1Low)
     Analog1LowProto.Analog1LowOrBuilder {
   public static final com.google.protobuf.Descriptors.Descriptor
       getDescriptor() {
     return Analog1LowProto.internal_static_Analog1Low_descriptor;
   }
   ...
   // Construct using Analog1LowProto.Analog1Low.newBuilder()
   private Builder() {
   ...
   public Analog1LowProto.Analog1Low getDefaultInstanceForType() {
     return Analog1LowProto.Analog1Low.getDefaultInstance();
   }

   public Analog1LowProto.Analog1Low build() {
     Analog1LowProto.Analog1Low result = buildPartial();
   ...
   public Analog1LowProto.Analog1Low buildPartial() {
     Analog1LowProto.Analog1Low result = new Analog1LowProto.Analog1Low(this);
   ...
   public Builder mergeFrom(com.google.protobuf.Message other) {
     if (other instanceof Analog1LowProto.Analog1Low) {
       return mergeFrom((Analog1LowProto.Analog1Low)other);
     } else {
   ...
   public Builder mergeFrom(Analog1LowProto.Analog1Low other) {
     if (other == Analog1LowProto.Analog1Low.getDefaultInstance()) return this;
     if (other.hasHeader()) {
   ...
   public Builder mergeFrom(
       ...
       com.google.protobuf.ExtensionRegistryLite extensionRegistry)
       throws java.io.IOException {
     Analog1LowProto.Analog1Low parsedMessage = null;
     try {
       parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
     } catch (com.google.protobuf.InvalidProtocolBufferException e) {
       parsedMessage = (Analog1LowProto.Analog1Low) e.getUnfinishedMessage();
       throw e;
     } finally {
   ...
   // @@protoc_insertion_point(builder_scope:Analog1Low)
 }

 static {
   defaultInstance = new Analog1Low(true);
   defaultInstance.initFields();
 }

 // @@protoc_insertion_point(class_scope:Analog1Low)
}

private static final com.google.protobuf.Descriptors.Descriptor
 internal_static_Analog1Low_descriptor;
private static
 com.google.protobuf.GeneratedMessage.FieldAccessorTable
   internal_static_Analog1Low_fieldAccessorTable;
...
static {
 java.lang.String[] descriptorData = {
   "\n\025Analog1LowProto.proto\032\026EventHeaderProt" +
 ...
 internal_static_Analog1Low_fieldAccessorTable = new
   com.google.protobuf.GeneratedMessage.FieldAccessorTable(
     internal_static_Analog1Low_descriptor,
